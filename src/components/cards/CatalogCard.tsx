          ...
          <CardContent className="p-6 md:p-8 flex flex-col flex-1">
            ...
            <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                <p className="text-xs font-normal text-gray-400 uppercase tracking-widest mb-1">Mulai Dari</p>
  ...
  return (
    <Card className="group overflow-hidden bg-white dark:bg-gray-900 border-none shadow-sm hover:shadow-2xl transition-all duration-500 rounded-[2rem] h-full flex flex-col transform hover:-translate-y-2">
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2">
          {item.isPopular && (
            <Badge className="bg-orange-500/90 backdrop-blur-md text-white border-none px-3 py-1 rounded-full text-[10px] font-semibold tracking-widest uppercase">
              Popular
            </Badge>
          )}
          {item.isNew && (
            <Badge className="bg-blue-600/90 backdrop-blur-md text-white border-none px-3 py-1 rounded-full text-[10px] font-semibold tracking-widest uppercase">
              New
            </Badge>
          )}
          {item.discount && item.discount > 0 && (
            <Badge className="bg-red-500/90 backdrop-blur-md text-white border-none px-3 py-1 rounded-full text-[10px] font-semibold">
              -{item.discount}%
            </Badge>
          )}
        </div>
      ...
      <CardContent className="p-8 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
          ...
          <Button 
            onClick={handleDetailClick}
            className="bg-blue-600 hover:bg-blue-700 text-white rounded-2xl h-12 px-6 font-normal shadow-lg shadow-blue-600/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
          >
            Detail
