...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-900 backdrop-blur-md shadow-lg border-b border-gray-200/50 dark:border-gray-800/50 z-50 print:hidden">
